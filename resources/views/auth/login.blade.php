...
<head>
    ...
    <style>
        ...
        .account-pages::before {
            ...
            width: 100%;
            height: 100%;
            background: url('{{ asset('B/assets/images/inventory-control.jpg') }}') no-repeat center center;
                        ...
                        <div class="p-2 mt-4">
                            ...
                            <form action="{{ route('login') }}" method="post">
                                ...
                                <div class="mt-3 text-center">
                                    <p>Belum punya akun? <a href="{{ route('register') }}" class="fw-medium text-primary">Register</a></p>
                                </div>
                            </form>
                        </div>
                    </div>
